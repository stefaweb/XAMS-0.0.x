...
<?php if ($myUser->formular_errors) echo '<p class="formerror">'. $tl->get('The formular was not properly filled out. Point at the question mark.'). '</p>'; ?>
        ...
        <table width="680" class="tbl_global">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="quota" class="checkbox" value="-1"<?php if ($myUser->quota < 0) echo ' checked="checked"' ?> /> <?php echo $tl->get('unlimited') ?>
                </td>
