<?php
    ...
    if ($button)
    {
        ...
        'spamcheckin', 'spamcheckout', 'sites', 'addressbook_'));
...
<?php if ($myReseller->formular_errors) echo '<p class="formerror">'. $tl->get('The formular was not properly filled out. Point at the question mark.'). '</p>'; ?>
...
<th><?php echo $tl->get("Spam Score Trigger")?></th>
	...
	<input type="text" name="spamscore" value="<?php echo $myReseller->spamscore?>" maxlength="3" size="3" class="textfield" />
	<?php echo $tl->get("High Spam Score")?>:
	<input type="text" name="highspamscore" value="<?php echo $myReseller->highspamscore?>" maxlength="3" size="3" class="textfield" />
	</td>
