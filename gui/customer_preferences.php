<?php
    ...
    if ($button)
    {
        $myCustomer->Assign2Object(array('password', 'addressbook_', 'mode'));
...
<?php if ($myCustomer->formular_errors) echo '<p class="formerror">'. $tl->get('The formular was not properly filled out. Point at the question mark.'). '</p>'; ?>
